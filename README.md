...
<!-- BEGIN: auto-generated by scripts/gen_api_table.py — do not edit by hand. Re-run after adding or renaming an endpoint. -->

| Method | Path | Source |
| ------ | ---- | ------ |
| POST   | `/api/convert` | `routes/convert.py` |
| GET    | `/api/convert/formats` | `routes/convert.py` |
| GET    | `/api/dictionary` | `routes/dictionary.py` |
| PUT    | `/api/dictionary` | `routes/dictionary.py` |
| POST   | `/api/dictionary/reset` | `routes/dictionary.py` |
| GET    | `/api/suppressed` | `routes/dictionary.py` |
| POST   | `/api/suppressed` | `routes/dictionary.py` |
| DELETE | `/api/suppressed/{term_id}` | `routes/dictionary.py` |
| GET    | `/api/vocabulary` | `routes/dictionary.py` |
| POST   | `/api/vocabulary` | `routes/dictionary.py` |
| DELETE | `/api/vocabulary/{entry_id}` | `routes/dictionary.py` |
| PATCH  | `/api/vocabulary/{entry_id}` | `routes/dictionary.py` |
| POST   | `/api/extract` | `routes/extract.py` |
| POST   | `/api/preview-tags` | `routes/extract.py` |
| POST   | `/api/delete` | `routes/files.py` |
| GET    | `/api/files` | `routes/files.py` |
| GET    | `/api/files/debug` | `routes/files.py` |
| GET    | `/api/files/search` | `routes/files.py` |
| POST   | `/api/mkdir` | `routes/files.py` |
| POST   | `/api/move` | `routes/files.py` |
| POST   | `/api/move/batch` | `routes/files.py` |
| POST   | `/api/rename` | `routes/files.py` |
| POST   | `/api/rename-path` | `routes/files.py` |
| POST   | `/api/patreon/fetch` | `routes/patreon.py` |
| POST   | `/api/patreon/ingest-drive-link` | `routes/patreon.py` |
| POST   | `/api/patreon/ingest-external-audio` | `routes/patreon.py` |
| GET    | `/api/settings/google-cookie` | `routes/settings.py` |
| PUT    | `/api/settings/google-cookie` | `routes/settings.py` |
| GET    | `/api/settings/patreon-cookie` | `routes/settings.py` |
| PUT    | `/api/settings/patreon-cookie` | `routes/settings.py` |
| GET    | `/api/health` | `routes/system.py` |
| GET    | `/api/system/info` | `routes/system.py` |

<!-- END: auto-generated. Regenerate with: `backend/.venv/bin/python scripts/gen_api_table.py`. -->

Detailed request/response shapes for each endpoint follow below, grouped by domain.
