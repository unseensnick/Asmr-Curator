...
- FastAPI route handlers under `backend/routes/*.py` should raise `HTTPException` with explicit status codes (400 validation, 404 not found, 409 conflict, 500 unexpected). Don't return generic `{"error": "..."}` 200 responses.
